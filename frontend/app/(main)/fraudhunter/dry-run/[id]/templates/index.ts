...
import { ModelBatchBacktestTemplate } from './ModelBatchBacktestTemplate';
import { IndicatorTaskTemplate } from './IndicatorTaskTemplate';

// 任务类型到模板的映射
export const TASK_TEMPLATES = {
  'model_backtest': ModelBacktestTemplate,
  'model_batch_backtest': ModelBatchBacktestTemplate,
...
export { ModelBacktestTemplate, ModelBatchBacktestTemplate, IndicatorTaskTemplate };
