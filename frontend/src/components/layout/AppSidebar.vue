<template>
  <aside class="w-64 min-h-screen bg-base-200 border-r border-base-300">
    <div class="p-4">
      <!-- Quick Actions -->
      <div class="mb-6">
        <h3 class="text-sm font-semibold text-base-content/60 mb-3">快速操作</h3>
        <div class="space-y-2">
          <button
      ...
      <!-- Statistics -->
      <div class="mb-6">
        <h3 class="text-sm font-semibold text-base-content/60 mb-3">统计信息</h3>
        <div class="grid grid-cols-2 gap-3">
          <div class="stat p-3 bg-base-100 rounded-lg">
            <div class="stat-value text-lg">{{ queryStore.queryHistory.length }}</div>
            <div class="stat-desc text-xs">今日查询</div>
          </div>
          <div class="stat p-3 bg-base-100 rounded-lg">
            <div class="stat-value text-lg">{{ queryStore.favorites.length }}</div>
            <div class="stat-desc text-xs">收藏查询</div>
          </div>
        </div>
      </div>
      ...
      <div class="mb-6">
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-sm font-semibold text-base-content/60">最近查询</h3>
          <router-link
            to="/logs"
        ...
        <div class="space-y-2">
          ...
          >
            <div class="text-sm font-medium truncate">{{ query.userInput }}</div>
      ...
      <!-- Quick Links -->
      <div>
        <h3 class="text-sm font-semibold text-base-content/60 mb-3">快速链接</h3>
        <ul class="space-y-1">
          <li>
            <a
