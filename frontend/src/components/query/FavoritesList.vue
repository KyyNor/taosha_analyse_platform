<template>
  <div class="space-y-3">
    ...
    <div v-if="loading" class="text-center py-8">
      <LoadingSpinner size="sm" text="加载收藏列表..." />
    </div>
          ...
          <div class="flex items-start justify-between gap-3">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 mb-2">
                <h4 class="font-medium text-sm">{{ item.favoriteTitle }}</h4>
                <button
              ...
              <div class="mb-2">
                <p class="text-sm text-base-content/80 line-clamp-2">{{ item.userQuestion }}</p>
              </div>
  ...
  <dialog ref="editModal" class="modal">
    <div class="modal-box">
      <h3 class="font-bold text-lg">编辑收藏标题</h3>
