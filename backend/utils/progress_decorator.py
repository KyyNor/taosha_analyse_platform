...
def track_node_progress(node_name: str):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(state: Dict[str, Any]) -> Dict[str, Any]:
            ...
            # 记录节点开始
            start_log = progress_callback(node_name, f'流程开始', 50)
            ...
            try:
                ...
                progress_callback(node_name, f'{node_name}流程结束', 50, task_status=real_status,
                ...
                # 更新进度回调（如果有）
                if progress_callback:
                    progress_callback(node_name, f'{node_name}流程失败', 0, TaskStatus.FAILED)
